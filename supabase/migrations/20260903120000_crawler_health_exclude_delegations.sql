-- Crawler workflow health: anti-bot handoffs to the scrape caller are recorded
-- as terminal_failed/fallback_terminal by design. They are not crawler failures
-- and must not open operator incidents.
