 ...
 *   deno run --allow-env --allow-net --allow-read=. scripts/benchmark-firecrawl-map.ts
 *
 * Optional:
 *   deno run --allow-env --allow-net --allow-read=. scripts/benchmark-firecrawl-map.ts --set municipal
 *   deno run --allow-env --allow-net --allow-read=. scripts/benchmark-firecrawl-map.ts --set media
 *   deno run --allow-env --allow-net --allow-read=. scripts/benchmark-firecrawl-map.ts --scenario arlesheim
 *   deno run --allow-env --allow-net --allow-read=. scripts/benchmark-firecrawl-map.ts --strict
 */
